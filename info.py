...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001554748352') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002093748524') # request channel id ( make sure bot is admin )
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/nawabsupport') #Support group link ( make sure bot is admin )
